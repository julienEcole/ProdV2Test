<?php
	...
	class nettoyage{
		...
		public function suppLignes($removed = 1){// TODO quand je ferai le formulaire de dévalidaion il faudras modifier cet fonction
			...
			$sqlCommande = "UPDATE Company SET removed = $removed WHERE Id = '$this->_idCompany'";
			$this->executerCommandeSansReturn($sqlCommande);
		...
		public function suppTout($removed = 1){// TODO quand je ferai le formulaire de dévalidaion il faudras modifier cet fonction
			$result = $this->getNbLignesRemoved($removed);
			$this->_bdd->_SQLPointer->beginTransaction();		//jusque la la fonction semble sûr
